                  ...
                  FlutterSwitch(
                    ...
                    onToggle: (val) {
                      ...
                      if(status){
                        ...
                        temperature=TextEditingController()..text='Default temperature';
                        humidity=TextEditingController()..text='Default humidity';
                        soil_moisture=TextEditingController()..text='Default moisture';
                        daylight=TextEditingController()..text='Default daylight';
                      }else{
                ...
                child: Container(
                  ...
                  child: Column(
                    children: [
                      ...
                      ElevatedButton(
                        onPressed: () {
                          if(name.text=='' || temperature.text=='' || humidity.text=='' || soil_moisture.text=='' || daylight.text==''){
